...
export function Footer() {
  return (
    <footer className="border-t border-slate-200 dark:border-white/10 py-16 bg-slate-50 dark:bg-[#030712]">
      <div className="max-w-7xl mx-auto px-6 lg:px-10 grid md:grid-cols-2 lg:grid-cols-5 gap-12">
        ...
        <div className="lg:col-span-2">
          ...
          <p className="text-slate-500 dark:text-zinc-400 text-sm leading-relaxed mt-5 max-w-xs">
            Perth&apos;s trusted security partner. Fully licensed, police checked and insured security services across Western Australia.
          </p>
          <div className="mt-6 space-y-3 text-sm text-slate-500 dark:text-zinc-400">
        ...
        <div>
          <h4 className="font-bold text-slate-900 dark:text-white text-sm mb-4">Industries</h4>
          <div className="space-y-2.5 text-sm text-slate-500 dark:text-zinc-400">
            {industries.map((industry) => (
              <p key={industry.slug}>
                <Link href={`/industries/${industry.slug}`} className="hover:text-blue-600 dark:hover:text-cyan-400 transition-colors">
                  {industry.title}
                </Link>
              </p>
            ))}
        ...
        <div>
          ...
          <div className="space-y-2.5 text-sm text-slate-500 dark:text-zinc-400">
            ...
            <p><Link href="/contact" className="hover:text-blue-600 dark:hover:text-cyan-400 transition-colors">Contact Us</Link></p>
          </div>
        </div>
