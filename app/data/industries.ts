...
export const industries: Industry[] = [
...

  {
    ...
    benefits: [
      ...
      { title: "WHS Protocol Support", desc: "Our guards are briefed on your site's WHS requirements and support the enforcement of exclusion zones and safety protocols." },
...

  {
    ...
    faqs: [
      ...
      { q: "What happens if an incident occurs during the event?", a: "Our guards follow trained incident response protocols — de-escalating where possible, managing individuals out of the area, contacting police when required, and filing a full incident report. Every response is documented." },
    ],
